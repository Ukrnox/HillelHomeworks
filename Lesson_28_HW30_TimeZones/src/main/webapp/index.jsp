...
<head>
	...
	<title>MeetingPlanner</title>
     ...
     BODY
     {
    background: #c7b39b url(resources/img/1.png);
    }
    </style>
</head>
<form action="/meetingPl" method="POST">
<body align="center">
...
<option value="America/Nipigon">"America/New_York"</option>
...
<select id=iv name="intervalInMin">
...
<br><br>
<% String errorMassage = (String) request.getSession().getAttribute("errorMassage");
   String massageIfAllNA = (String) request.getSession().getAttribute("massageIfAllNA");
        if(errorMassage != null)
        {
            out.print("<p><font size='6' color='#0000FF' face='serif'>");
            out.print(errorMassage);
            out.print("</font></p>");
        }
        if(massageIfAllNA != null)
        {
             out.print("<p><font size='6' color='#0000FF' face='serif'>");
             out.print(massageIfAllNA);
             out.print("</font></p>");
        }
%>
<br><br>
